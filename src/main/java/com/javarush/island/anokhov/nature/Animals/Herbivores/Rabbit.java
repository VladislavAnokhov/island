...
import com.javarush.island.anokhov.constants.animalsBasic.RabbitBasic;
...
public class Rabbit extends Herbivore {
    ...
    public  Rabbit( String name , int maxQuantity,Double weight,int speed,int reproduceCounter,Double wellFed ){
        this.name = name;
