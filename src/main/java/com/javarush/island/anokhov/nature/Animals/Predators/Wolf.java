...
import com.javarush.island.anokhov.constants.animalsBasic.WolfBasic;
...
public class Wolf extends Predator {
    ...
    public HashMap<String, Integer> getMenu() {
        ...
        return WolfBasic.getMenu();
    }



    public  Wolf( String name , int maxQuantity,Double weight,int speed,int reproduceCounter,Double wellFed ){
        this.name = name;
