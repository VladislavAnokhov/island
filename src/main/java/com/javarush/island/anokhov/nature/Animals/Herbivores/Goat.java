...
import com.javarush.island.anokhov.constants.animalsBasic.GoatBasic;
...
public class Goat extends Herbivore {
    ...
    private String name;
    public  Goat( String name , int maxQuantity,Double weight,int speed,int reproduceCounter,Double wellFed ){
        this.name = name;
