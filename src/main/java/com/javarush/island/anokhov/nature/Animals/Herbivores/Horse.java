...
import com.javarush.island.anokhov.constants.animalsBasic.HorseBasic;
...
public class Horse extends Herbivore {
    ...
    public  Horse( String name , int maxQuantity,Double weight,int speed,int reproduceCounter,Double wellFed ){
        this.name = name;
