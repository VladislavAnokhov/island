...
import com.javarush.island.anokhov.constants.animalsBasic.BuffaloBasic;
...
public class Buffalo extends Herbivore {
    ...
    public  Buffalo( String name , int maxQuantity,Double weight,int speed,int reproduceCounter,Double wellFed ){
        this.name = name;
