...
import com.javarush.island.anokhov.constants.animalsBasic.CaterpillarBasic;
...
public class Caterpillar extends Herbivore {
    ...
    public  Caterpillar( String name , int maxQuantity,Double weight,int speed,int reproduceCounter,Double wellFed ){
        this.name = name;
    ...
    public HashMap<String, Integer> getMenu() {
        return CaterpillarBasic.getMenu();
    }
