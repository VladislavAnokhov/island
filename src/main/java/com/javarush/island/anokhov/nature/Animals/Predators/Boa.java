...
import com.javarush.island.anokhov.constants.animalsBasic.BoaBasic;
...
public class Boa extends Predator {
    ...
    public  Boa( String name , int maxQuantity,Double weight,int speed,int reproduceCounter,Double wellFed ){
        this.name = name;
