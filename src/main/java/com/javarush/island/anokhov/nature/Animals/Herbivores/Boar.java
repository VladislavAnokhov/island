...
import com.javarush.island.anokhov.constants.animalsBasic.BoarBasic;
...
public class Boar extends Herbivore {
    ...
    private String name;
    public  Boar( String name , int maxQuantity,Double weight,int speed,int reproduceCounter,Double wellFed ){
        this.name = name;
