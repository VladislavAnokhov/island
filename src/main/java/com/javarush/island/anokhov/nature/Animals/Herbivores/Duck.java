...
import com.javarush.island.anokhov.constants.animalsBasic.DuckBasic;
...
public class Duck extends Herbivore {
    ...
    public  Duck( String name , int maxQuantity,Double weight,int speed,int reproduceCounter,Double wellFed ){
        this.name = name;
